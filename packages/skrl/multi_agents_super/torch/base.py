...
class MultiAgentSuper:
    def __init__(
        ...
        # agent_policies: Mapping[str, str],  # bw新增：指定每个智能体的策略类型
        # policy_classes: Mapping[str, Any],  # bw新增：策略类映射
        ...
        :param agent_policies: 每个智能体使用的策略类型（如 "ppo", "amp"）
        :param policy_classes: 策略类型到策略类的映射
        ...
        # self.agent_policies = agent_policies  # 存储每个智能体的策略类型
        # self.policy_classes = policy_classes  # 存储策略类映射        

        # # 为每个智能体创建策略实例
        # self.agents: Dict[str, Agent] = {}
        # for agent in self.possible_agents:
        #     policy_type = agent_policies[agent]
        #     policy_cls = policy_classes[policy_type]
            
        #     # 创建策略实例
        #     self.agents[agent] = policy_cls(
        #         models=models[agent],
        #         memory=memories[agent] if memories else None,
        #         observation_space=observation_spaces[agent] if observation_spaces else None,
        #         action_space=action_spaces[agent] if action_spaces else None,
        #         device=device,
        #         cfg=cfg.get(agent, {})  # 智能体特定配置
        #     )
