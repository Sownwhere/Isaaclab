...
from .bw_exo_cfg import BWEXO_CFG
...
@configclass
class BwExoAmpEnvCfg(DirectRLEnvCfg):
    ...
    * random-start: pose and joint states are set by sampling motion at the start (time zero).
    ...
    # robot
    robot: ArticulationCfg = BWEXO_CFG.replace(prim_path="/World/envs/env_.*/Robot")
...
@configclass
class BwExoAmpWalkEnvCfg(BwExoAmpEnvCfg):
