...
from .ma_env_cfg import Exo1EnvCfg
...
class MaEnv(DirectRLEnv):
    cfg: Exo1EnvCfg

    def __init__(self, cfg: Exo1EnvCfg, render_mode: str | None = None, **kwargs):
...
def compute_rewards(
    ...
    total_reward = rew_alive + rew_termination + rew_pole_pos
    return total_reward